...
Проверено (`./check_all.sh` — проверочная разводка для всех плат сразу):
Colorlight i9 (45F) — 23 % LUT, 54 МГц; Colorlight i5 (25F) — 42 % LUT, 56 МГц;
ULX3S (85F) — 12 % LUT, 55 МГц при рабочих 50 МГц.
